...
public class EpisodicPlane
     ...
     */
    public EpisodicPlane(OWLReferences onto) {
     ...
     */
    public EpisodicPlane(String ontoName) {
     ...
     * @param onto the {@link OWLReferences} ontology that will contain the object individual.
     */
    public EpisodicPlane(OWLNamedIndividual instance, OWLReferences onto) {
        super(instance, onto);
        initialiseProperty();
    }
    /**
     ...
     * @param onto the {@link OWLReferences} ontology that will contain the object individual.
     */
    public EpisodicPlane(String instanceName, OWLReferences onto) {
     ...
     * @param ontoName the name of the {@link OWLReferences} ontology that will contain the object individual.
     */
    public EpisodicPlane(OWLNamedIndividual instance, String ontoName) {
     ...
     * @param ontoName the name of the {@link OWLReferences} ontology that will contain the object individual.
     */
    public EpisodicPlane(String instanceName, String ontoName) {
